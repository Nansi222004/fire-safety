    ...
    <PageTransition>
      <div className="min-h-screen bg-[#F8FAFC] text-[#1F2937] flex flex-col justify-between selection:bg-red-500 selection:text-white">
        ...
        <main className="flex-1 flex items-center justify-center p-4 py-8 sm:py-12">
          ...
          >
            ...
            <div className="text-center space-y-3">
              ...
              <div>
                <h1 className="text-2xl font-extrabold text-[#0F172A] tracking-tight">Admin Login</h1>
                <p className="text-xs text-[#64748B] mt-1">
                  Enter your credentials to access the SafeFire administration console
                </p>
              </div>
            </div>
            ...
            >
              ...
              <p className="text-xs text-[#64748B]">Email: <span className="font-semibold text-[#0F172A]">sfsappdevelopment@gmail.com</span></p>
              <p className="text-xs text-[#64748B]">Password: <span className="font-semibold text-[#0F172A]">admin123</span></p>
            </div>
          </motion.div>
        </main>
        ...
        <footer className="py-4 text-center text-xs text-[#64748B] border-t border-[#E5E7EB] bg-white">
          © {new Date().getFullYear()} SafeFire Administration. Certified Fire Safety & Compliance Platform.
        </footer>
      </div>
    </PageTransition>
  );
